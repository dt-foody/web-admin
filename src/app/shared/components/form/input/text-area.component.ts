...
export class TextAreaComponent {
  ...
  get textareaClasses(): string {
    ...
    if (this.disabled) {
      ...
      base +=
        'bg-transparent text-gray-900 dark:text-gray-300 border-gray-300 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:focus:border-brand-800 placeholder:text-gray-400 dark:placeholder:text-gray-500';
    }
    return base;
  }
}
