...
//     this.order.status = statusKey; // cập nhật UI ngay

//     this.orderService.adminUpdateOrder(this.order.orderId, { status: statusKey }).subscribe({
//       next: (res) => {
...
//         this.order.status = oldStatus; // revert nếu lỗi
//       },
//     });
//   }
